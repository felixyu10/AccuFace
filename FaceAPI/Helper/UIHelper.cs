...
namespace FaceAPI.Web.Helper
{
    ...
    internal static class UIHelper
    {
        ...
        public static IEnumerable<FaceDetectionModel> CalculateFaceRectangleForRendering(IEnumerable<Microsoft.ProjectOxford.Face.Contract.Face> faces, int maxSize, Tuple<int, int> imageInfo)
        {
            ...
            {
                yield return new FaceDetectionModel()
                {
